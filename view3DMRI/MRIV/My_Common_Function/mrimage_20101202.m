...
% added at 2010.04.18
uimenu(menu_hndl, 'Label', 'Phase','Separator','on', 'Callback', {@plot_phase,menu_hndl,im,clim});
% added at 2010.04.18
uimenu(menu_hndl, 'Label', 'Export to Base Workspace','Separator','on', 'Callback', {@local_export2BS,im});
...
% added at 2010.04.18
uimenu(miniCmap_menuhndl,'Label','Save & Remove Clim','Separator','on', 'Callback',{@remove_clim,menu_hndl,im});
uimenu(miniCmap_menuhndl,'Label','Restore Clim', 'Callback',{@restore_clim,miniCmap_menuhndl,menu_hndl,im});
% added at 2010.04.19
uimenu(miniCmap_menuhndl,'Label','Save & Remove Global Clim','Separator','on','Callback',{@remove_global_clim,menu_hndl,im});
uimenu(miniCmap_menuhndl,'Label','Restore Global Clim', 'Callback',{@restore_global_clim,menu_hndl,im});


plot_image(menu_hndl,im,clim);
colormap('gray');
...
function plot_image(menu_hndl,im,clim)
% added at 2010.04.18
...
function plot_phase(gcbo, eventdata,menu_hndl,im,clim)
% added at 2010.04.18
...
function remove_clim(gcbo, eventdata,menu_hndl,im)
% added at 2010.04.18
...
plot_image(menu_hndl,im,[])

function restore_clim(gcbo, eventdata,miniCmap_menuhndl,menu_hndl,im)
% added at 2010.04.18
% global mrimage_global_clim;
% 
...
function remove_global_clim(gcbo, eventdata,menu_hndl,im)
% added at 2010.04.19
global mrimage_global_clim;
...
function restore_global_clim(gcbo, eventdata,menu_hndl,im)
% added at 2010.04.19
global mrimage_global_clim;
...
function local_export2BS(gcbo, eventdata,im)
% added at 2010.04.18
