...
% Last Modified by GUIDE v2.5 25-Apr-2010 00:02:57
...
msgbox({'MRI 3D Data Viewer ver.9.0',...
    'still WIP ;;;',...
...
global Gv3Dchk_mip;
global Gv3Dchk_minip;
global Gv3Dcur_Intensity;
global Gv3Disphase;
global Gv3DcurCmap;
...
%                     min(max(mag(temp(:))),Gv3Dcur_max_Intensity)],1);
                mrimagef(temp,[Gv3Dcur_Intensity.min,...
...
global Gv3Dchk_mip;
global Gv3Dchk_minip;
global Gv3D_Intensity;
global Gv3Dcur_Intensity;
global Gv3Disphase;
global Gv3DmatchAllaxes;
global Gv3DcurCmap;
global Gv3Dapply_curCmap2all;
global apply_Gv3DcurCmap2enlarged;
% global Gv3Dres;
global Gv3DaxesOn;
global Gv3DindexLine;
...
% --------------------------------------------------------------------
function my_plot_index_Line(handles)
% this function added at 2010.04.24  3 a.m.
% good job
...
try
    if Gv3DindexLine && Gv3Dimage_spec.is3D
        ...
        if cur_axes_handle==handles.axes1
            axes(handles.axes2);
            delete(findobj(get(gca,'children'),'tag','z_indexLine_in_yz'))
            line([Gv3Dslice_index.xy Gv3Dslice_index.xy],[1-0.5 Gv3Dimage_spec.ny+0.5],'color','g','tag','z_indexLine_in_yz')
            
            axes(handles.axes3);
            delete(findobj(get(gca,'children'),'tag','z_indexLine_in_xz'))
            line([1-0.5 Gv3Dimage_spec.nx+0.5],[Gv3Dslice_index.xy Gv3Dslice_index.xy],'color','g','tag','z_indexLine_in_xz')
        ...
        if cur_axes_handle==handles.axes2
            axes(handles.axes1);
            delete(findobj(get(gca,'children'),'tag','x_indexLine_in_xy'))
            line([Gv3Dslice_index.yz Gv3Dslice_index.yz],[1-0.5 Gv3Dimage_spec.ny+0.5],'color','r','tag','x_indexLine_in_xy')
            
            axes(handles.axes3);
            delete(findobj(get(gca,'children'),'tag','x_indexLine_in_xz'))
            line([Gv3Dslice_index.yz Gv3Dslice_index.yz],[1-0.5 Gv3Dimage_spec.nz+0.5],'color','r','tag','x_indexLine_in_xz')
        ...
        if cur_axes_handle==handles.axes3
            axes(handles.axes1);
            delete(findobj(get(gca,'children'),'tag','y_indexLine_in_xy'))
            line([1-0.5 Gv3Dimage_spec.nx+0.5],[Gv3Dslice_index.xz Gv3Dslice_index.xz],'color','y','tag','y_indexLine_in_xy')
            
            axes(handles.axes2);
            delete(findobj(get(gca,'children'),'tag','y_indexLine_in_yz'))
            line([1-0.5 Gv3Dimage_spec.nz+0.5],[Gv3Dslice_index.xz Gv3Dslice_index.xz],'color','y','tag','y_indexLine_in_yz')
