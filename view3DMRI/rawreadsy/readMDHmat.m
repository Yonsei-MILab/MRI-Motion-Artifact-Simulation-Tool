...
mMDH(1:7)                             = fread(fid, 7, 'uint32');      % 28

mMDH(8:27)                        = fread(fid, 20, 'uint16');      % 40

mMDH(28)                       = fread(fid, 1, 'float');       % 68 + 4 = 72
mMDH(29)                       = fread(fid, 1, 'uint32');       % 72 + 4 = 76

mMDH(30:39)                   = fread(fid, 10, 'uint16');       % 76 + 20 = 96

mMDH(40:46)                       = fread(fid, 7, 'float');       % 96 + 28 = 124

mMDH(47:48)                             = fread(fid, 2, 'uint16');      % 124 + 4 = 128 OK!
mMDH(48) = -mMDH(48);
